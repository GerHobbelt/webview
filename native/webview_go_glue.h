...
WEBVIEW_API void CgoWebViewBind(webview_t w, const char *name,
                                              uintptr_t index);

WEBVIEW_API void
set_webviewDispatchGoCallback(_webviewDispatchGoCallback_t callback);
WEBVIEW_API void
set_webviewBindingGoCallback(_webviewBindingGoCallback_t callback);
